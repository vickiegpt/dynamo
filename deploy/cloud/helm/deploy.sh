...
export DYNAMOGRAPH_DOCKER_SERVER="${DYNAMOGRAPH_DOCKER_SERVER:=${DOCKER_SERVER}}"
export DYNAMOGRAPH_DOCKER_USERNAME="${DYNAMOGRAPH_DOCKER_USERNAME:=${DOCKER_USERNAME}}"
export DYNAMOGRAPH_DOCKER_PASSWORD="${DYNAMOGRAPH_DOCKER_PASSWORD:=${DOCKER_PASSWORD}}"
...
echo "DYNAMOGRAPH_DOCKER_SERVER: $DYNAMOGRAPH_DOCKER_SERVER"
echo "DYNAMOGRAPH_DOCKER_USERNAME: $DYNAMOGRAPH_DOCKER_USERNAME"
echo "DYNAMOGRAPH_DOCKER_PASSWORD: [HIDDEN]"
