...
export DYNAMO_GRAPH_DOCKER_SERVER="${DYNAMO_GRAPH_DOCKER_SERVER:=${DOCKER_SERVER}}"
export DYNAMO_GRAPH_DOCKER_USERNAME="${DYNAMO_GRAPH_DOCKER_USERNAME:=${DOCKER_USERNAME}}"
export DYNAMO_GRAPH_DOCKER_PASSWORD="${DYNAMO_GRAPH_DOCKER_PASSWORD:=${DOCKER_PASSWORD}}"
...
echo "DYNAMO_GRAPH_DOCKER_SERVER: $DYNAMO_GRAPH_DOCKER_SERVER"
echo "DYNAMO_GRAPH_DOCKER_USERNAME: $DYNAMO_GRAPH_DOCKER_USERNAME"
echo "DYNAMO_GRAPH_DOCKER_PASSWORD: [HIDDEN]"
