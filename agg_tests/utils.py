...
def check_service_health(
    ...
    Args:
        ...
        callback: Optional callback function to validate the response
    """
    for attempt in range(max_retries):
        try:
            ...
            if response.status_code == 200:
                ...
                # Default validation for models endpoint
            ...
            print(f"Health check failed (attempt {attempt + 1}/{max_retries}): {e}")
        except Exception as e:
            print(f"Unexpected error during health check (attempt {attempt + 1}/{max_retries}): {e}")
