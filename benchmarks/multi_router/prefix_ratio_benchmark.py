...
def run_benchmark(
    ...
    1. Single URL, in Kubernetes: Uses Kubernetes Service load balancing
    2. Multiple URLs, locally: Manual traffic splitting
       - Splits requests/concurrency across URLs
    """
    logger.info(
...
def main():
    ...
    parser.add_argument(
        ...
        help="Server URL(s). Single URL uses k8s Service load balancing. Multiple URLs split traffic manually.",
    )
    parser.add_argument(
        "--output-dir",
        type=str,
        default="results/kv_two_routers",
