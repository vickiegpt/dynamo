...
This folder implements the example of [SGLang DeepSeek-R1 Disaggregated with WideEP](../docs/dsr1-wideep.md) on a SLURM cluster.

## Overview

The scripts in this folder set up multiple cluster nodes to run the [SGLang DeepSeek-R1 Disaggregated with WideEP](../docs/dsr1-wideep.md) example, with separate nodes handling prefill and decode.
...
3. We assume you have already built a recent Dynamo+SGLang container image as
   described in the [prerequisites section](../docs/dsr1-wideep.md#prerequisites).
