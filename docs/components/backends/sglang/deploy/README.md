...
1. **Dynamo Kubernetes Platform installed** - See [Installing the Dynamo Kubernetes Platform](../../../../guides/dynamo_deploy/dynamo_cloud.md)
...
For additional support, refer to the [Dynamo Kubernetes Platform guide](../../../../guides/dynamo_deploy/dynamo_cloud.md)
