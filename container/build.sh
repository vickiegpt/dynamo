...
AWS_CONTAINER_AUTHORIZATION_IMAGE_TOKEN_BASENAME=$(basename ${AWS_CONTAINER_AUTHORIZATION_IMAGE_TOKEN_FILE})
...
if [ "$USE_SCCACHE" = true ]; then
    ...
    BUILD_ARGS+=" --build-arg AWS_CONTAINER_AUTHORIZATION_IMAGE_TOKEN_BASENAME=${AWS_CONTAINER_AUTHORIZATION_IMAGE_TOKEN_BASENAME}"
    BUILD_ARGS+=" --secret id=${AWS_CONTAINER_AUTHORIZATION_IMAGE_TOKEN_BASENAME},src=${AWS_CONTAINER_AUTHORIZATION_HOST_TOKEN_FILE},target=${AWS_CONTAINER_AUTHORIZATION_IMAGE_TOKEN_FILE}"
fi
