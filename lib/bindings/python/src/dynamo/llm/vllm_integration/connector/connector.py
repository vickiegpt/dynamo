...
@dataclass
class DynamoKvbmConnectorOnboardMetadata():
    request_id: str
    host_block_ids: Optional[list[int]] = None
    disk_block_ids: Optional[list[int]] = None

@dataclass
class DynamoKvbmConnectorMetadata(KVConnectorMetadata):
    requests: list[DynamoKvbmConnectorOnboardMetadata] = field(default_factory=list)
