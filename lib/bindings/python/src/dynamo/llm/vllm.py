...
class KVCacheManager:
    ...
    def get_computed_blocks(self,
        ...
        # intercept here to token_ids, salt_hash and mm hashes per blocks,
        # we will compute the hashes ourselves for now and find a way to integrate

        # detemine if this is a new request not seen before, if so, we will add extra
        # infomation to the return object, or we will create the intenral rust stateful
        # slot/kv manager entry to track this request

        # perform match

        # return dyanmo vllm kvblocks protocol object
        # this object will contain a superset of the vllm kvblocks object plus any details
        # we need to pass to the rust stateful slot/kv manager
