...
class RuntimeMetrics:
    ...
    def create_countervec(self, name: str, description: str, label_names: List[str]) -> CounterVec:
        """Create a CounterVec metric with labels (float)"""
        ...

    def create_gauge(self, name: str, description: str, labels: Optional[List[Tuple[str, str]]] = None) -> Gauge:
        """Create a Gauge metric (float) with optional static labels"""
        ...

    def create_histogram(self, name: str, description: str, labels: Optional[List[Tuple[str, str]]] = None) -> Histogram:
        """Create a Histogram metric with optional static labels"""
        ...

    def create_intcounter(self, name: str, description: str, labels: Optional[List[Tuple[str, str]]] = None) -> IntCounter:
        """Create an IntCounter metric (integer) with optional static labels"""
        ...

    def create_intcountervec(self, name: str, description: str, label_names: List[str]) -> IntCounterVec:
        """Create an IntCounterVec metric with labels (integer)"""
        ...

    def create_intgauge(self, name: str, description: str, labels: Optional[List[Tuple[str, str]]] = None) -> IntGauge:
        """Create an IntGauge metric (integer) with optional static labels"""
        ...

    def create_gaugevec(self, name: str, description: str, label_names: List[str]) -> GaugeVec:
        """Create a GaugeVec metric with labels (float)"""
        ...

    def create_intgaugevec(self, name: str, description: str, label_names: List[str]) -> IntGaugeVec:
