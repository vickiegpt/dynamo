...
pub struct NvCreateChatCompletionResponse {
    ...
    pub choices: Vec<NvChatChoice>,
    /// The Unix timestamp (in seconds) of when the chat completion was created.
    pub created: u32,
    /// The model used for the chat completion.
    pub model: String,
    /// The service tier used for processing the request. This field is only included if the `service_tier` parameter is specified in the request.
    pub service_tier: Option<async_openai::types::ServiceTierResponse>,
...
#[derive(Serialize, Deserialize, Validate, Debug, Clone)]
pub struct NvChatChoice {
    /// The index of the choice in the list of choices.
    pub index: u32,
    pub message: NvChatCompletionResponseMessage,
...
#[derive(Serialize, Deserialize, Validate, Debug, Clone)]
pub struct NvChatCompletionResponseMessage {
    /// The contents of the message.
    pub content: Option<String>,
    /// The refusal message generated by the model.
    pub refusal: Option<String>,
    /// The tool calls generated by the model, such as function calls.
    pub tool_calls: Option<Vec<async_openai::types::ChatCompletionMessageToolCall>>,

    /// The role of the author of this message.
    pub role: async_openai::types::Role,

    //// Nvidia specific extensions following what vLLM and SGLang do
    /// The reasoning content generated by the model, if applicable.
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(default)]
    ...
    #[deprecated]
    pub function_call: Option<async_openai::types::FunctionCall>,
    ...
    pub audio: Option<async_openai::types::ChatCompletionResponseMessageAudio>,
}
...
pub struct NvCreateChatCompletionStreamResponse {
    ...
    pub choices: Vec<NvChatChoiceStream>,
...
#[derive(Serialize, Deserialize, Validate, Debug, Clone)]
pub struct NvChatChoiceStream {
    /// The index of the choice in the list of choices.
    pub index: u32,
    pub delta: NvChatCompletionStreamResponseDelta,
...
#[derive(Serialize, Deserialize, Validate, Debug, Clone)]
pub struct NvChatCompletionStreamResponseDelta {
    /// The contents of the chunk message.
    pub content: Option<String>,
    /// Deprecated and replaced by `tool_calls`. The name and arguments of a function that should be called, as generated by the model.
    #[deprecated]
    pub function_call: Option<async_openai::types::FunctionCallStream>,
    ...
    pub tool_calls: Option<Vec<async_openai::types::ChatCompletionMessageToolCallChunk>>,
    /// The role of the author of this message.
    pub role: Option<async_openai::types::Role>,
    /// The refusal message generated by the model.
    pub refusal: Option<String>,
}
